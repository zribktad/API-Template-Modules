...
Step-by-step workflow guides for this API template. Each guide covers a complete end-to-end example you can follow to
extend the project.
...
| [Security](SECURITY.md)                         | Security headers (CSP, HSTS), CSRF protection, and data redaction                         |
