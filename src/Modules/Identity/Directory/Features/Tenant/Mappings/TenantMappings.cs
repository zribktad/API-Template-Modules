...
namespace Identity.Directory.Features.Tenant.Mappings;
...
{
    /// <summary>
    ///     Expression tree used by EF Core to project a <c>Tenant</c> entity directly to a <see cref="TenantResponse" /> in
    ///     the database query.
    /// </summary>
    ...
    /// </summary>
    public static TenantResponse ToResponse(this TenantEntity tenant)
    {
        return CompiledProjection(tenant);
    }
}
