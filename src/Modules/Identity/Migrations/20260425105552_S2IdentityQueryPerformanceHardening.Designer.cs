...
namespace Identity.Migrations
{
    ...
    [Migration("20260425105552_S2IdentityQueryPerformanceHardening")]
            ...
            modelBuilder.Entity("Identity.Directory.Entities.AppUser", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Email", "Identity.Directory.Entities.AppUser.Email#NormalizedString", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Username", "Identity.Directory.Entities.AppUser.Username#NormalizedString", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.HasAnnotation("CustomIndex:CompositeIndexes", "[{\"paths\":[\"TenantId\",\"Email.Normalized\"],\"unique\":true},{\"paths\":[\"TenantId\",\"Username.Normalized\"],\"unique\":true}]");
                });
            ...
            modelBuilder.Entity("Identity.Directory.Entities.TenantInvitation", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Email", "Identity.Directory.Entities.TenantInvitation.Email#NormalizedString", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.HasAnnotation("CustomIndex:CompositeIndexes", "[{\"paths\":[\"TenantId\",\"Email.Normalized\"],\"unique\":false}]");
                });
