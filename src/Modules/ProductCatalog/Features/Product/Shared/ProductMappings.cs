...
/// <summary>
///     Provides EF Core-compatible projection expressions and in-memory mapping helpers for converting <c>Product</c>
///     domain entities to <see cref="ProductResponse" /> DTOs.
/// </summary>
public static class ProductMappings
{
    /// <summary>
    ///     LINQ expression that projects a <c>Product</c> entity to a <see cref="ProductResponse" />; safe to pass directly
    ///     into EF Core queries.
    /// </summary>
    ...
    /// <summary>
    ///     Maps a fully-loaded <c>Product</c> entity to a <see cref="ProductResponse" /> using the pre-compiled
    ///     projection.
    /// </summary>
    public static ProductResponse ToResponse(this ProductEntity product)
    {
        return CompiledProjection(product);
    }
}
