...
///         inside the active outer transaction by using a savepoint and inherit the active outer policy. Conflicting
///         nested
...
public interface IUnitOfWork
{
    ...
    ///     This method must not be called inside
    ...
    ///     The outermost call owns the database transaction and retry strategy; nested calls use savepoints inside the active
    ///     transaction.
    ...
    ///     When <paramref name="options" /> is provided, its non-null values override the configured transaction defaults for
    ///     the outermost call.
