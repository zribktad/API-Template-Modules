...
namespace APITemplate.Infrastructure.Migrations
{
    ...
    [Migration("20260316202617_AddFailedEmailExpirationIndex")]
    partial class AddFailedEmailExpirationIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APITemplate.Domain.Entities.FailedEmail", b =>
                {
                    ...
                    b.HasIndex("IsDeadLettered", "CreatedAtUtc");

                    b.HasIndex("IsDeadLettered", "RetryCount", "LastAttemptAtUtc");
