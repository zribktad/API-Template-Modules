...
| **Api** | `UsersController`, `TenantsController`, `TenantInvitationsController`, `BffController`, `Authorization/` (PermissionAuthorizationHandler, PermissionPolicyProvider, CsrfValidationMiddleware, IdentityTokenValidatedPipeline, CookieSessionRefresher), `IdentityModule.cs` |
